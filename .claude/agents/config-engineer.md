...
description: "Sigil — Config Engineer. Gere settings.json, permissions, allowlists, deny rules, sandbox modes. Resolve permission prompts e optimiza configurações."
model: sonnet
tools:
  - Read
  - Grep
