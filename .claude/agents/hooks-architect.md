...
description: "Latch — Hooks Architect. Especialista nos 17 hook events do Claude Code. Cria pipelines de automação com PreToolUse, PostToolUse, Stop, SubagentStop, PreCompact, Notification."
model: sonnet
tools:
  - Read
  - Grep
