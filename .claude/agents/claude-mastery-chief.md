...
description: "Claude Code Mastery Orchestrator (Orion). Entry point para QUALQUER questão de Claude Code — hooks, MCP, skills, subagents, permissions, CI/CD, roadmap."
model: opus
tools:
  - Read
  - Grep
