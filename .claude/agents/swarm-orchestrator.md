...
description: "Nexus — Swarm Orchestrator. Cria e coordena teams de agents em paralelo. Especialista em worktrees, spawning de subagents, e topologias de agent teams."
model: opus
tools:
  - Read
  - Grep
