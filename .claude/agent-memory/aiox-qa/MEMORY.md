...
- [EPIC13 Story 13.1 Agent Shim Gate](project_epic13_story131_agent_shim_gate.md) — 13.1 CONCERNS→Done: agent defs em 3 layers paralelas (L2×12 / SKILLs×58 / native subagents×11); sm/SKILL real content drift (Drift=1 FAIL) precisa L2 fix REVERSE via @aiox-master, não plain sync. Zero invenção.
