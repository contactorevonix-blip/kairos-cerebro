...
- [Story 12.1 L1/L2 deny restore](project_story121_l1l2_deny_restore.md) — L1/L2 movidos de allow→deny em settings.json (estavam errados desde EPIC-8); isProtectedPath endurecido. NOTA: MultiEdit NÃO está nos PreToolUse matchers do settings.json actual (teste 12.1 falha por isto, 2026-06-20) — cobertura por verificar
